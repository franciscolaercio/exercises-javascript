...
addTechBtn.addEventListener('click', function(ev) {
    ...
    newRow.append(
        techNameLabel, techNameInput, document.createElement('br'), expLabel, expRadio1, expLabel1, expRadio2, expLabel2, expRadio3, expLabel3, document.createElement('br'), removeRowBtn
    )
